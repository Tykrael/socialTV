...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			message: 'Ajoutez la web app de<br />l\'émission sur votre %device !<br />Cliquez sur "icône favori" : %icon<br />puis "Ajouter à l\'écran d\'accueil" ',				// Customize your message or force a language ('' = automatic)
